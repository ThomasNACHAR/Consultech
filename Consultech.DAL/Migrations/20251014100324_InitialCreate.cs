        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivitySector = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultantSkill", x => new { x.ConsultantsId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_ConsultantSkill_Consultants_ConsultantsId",
                        column: x => x.ConsultantsId,
                        principalTable: "Consultants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsultantSkill_Skills_SkillsId",
                        column: x => x.SkillsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultantSkill_SkillsId",
